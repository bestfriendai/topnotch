...
#ifndef TOP_NOTCH_SWIFT_H
#define TOP_NOTCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Top_Notch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Top_Notch11AppDelegate")
@interface AppDelegate : NSObject <NSApplicationDelegate>
- (void)applicationDidFinishLaunching:(NSNotification * _Nonnull)notification;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC9Top_Notch10NotchPanel")
@interface NotchPanel : NSPanel
- (nonnull instancetype)initWithContentRect:(NSRect)contentRect styleMask:(NSWindowStyleMask)styleMask backing:(NSBackingStoreType)backing defer:(BOOL)flag OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly) BOOL canBecomeKeyWindow;
@property (nonatomic, readonly) BOOL canBecomeMainWindow;
@end

SWIFT_CLASS("_TtC9Top_Notch24SettingsWindowController")
...
SWIFT_CLASS("_TtC9Top_Notch24VideoPlayerNSContentView")
@interface VideoPlayerNSContentView : NSView
...
SWIFT_CLASS("_TtC9Top_Notch16VideoPlayerPanel")
@interface VideoPlayerPanel : NSPanel
...
SWIFT_CLASS("_TtC9Top_Notch18VideoWindowManager")
@interface VideoWindowManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@interface VideoWindowManager (SWIFT_EXTENSION(Top_Notch)) <NSWindowDelegate>
